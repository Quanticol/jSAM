 ...
 *
 */
public class Herman5 extends JPrismModule {
	...
	public static final int[] _LOWER_BOUNDS_ = { 0 , 0 , 0 , 0 , 0 };
	public static final int[] _UPPER_BOUNDS_ = { 1 , 1 , 1 , 1 , 1 };
	...
	public final int _MACRO_num_tokens( JPrismState current_state ) {
		...
		return (_var_x1==_var_x2?1:0)+(_var_x2==_var_x3?1:0)+(_var_x3==_var_x4?1:0)+(_var_x4==_var_x5?1:0)+(_var_x5==_var_x1?1:0);
	}
	...
	protected Distribution<JPrismState> doComputeNext(JPrismState current_state) {
		...
		boolean _guard_process1_1 = (_var_x1==_var_x5);
		boolean _guard_process1_2 = !(_var_x1==_var_x5);
			...
			if (((_guard_process1_1)||(_guard_process1_2))
				...
				{//START: process1
					...
					if (_guard_process1_2) {
						next_step_process1.set(foo_state.set( _VAR_x1 , _var_x5 ) , value*(1.0) );;
					}
	...
	protected JPrismState initializeStartState() {
		return new JPrismState(this, this.enumerator.enumerate(0,0,0,0,0));
	}
