 ...
 *
 */
public class FlyFastModelCheckerExtension extends AbstractPopulationModelCheckerExtension {

	private static final String MODELCHECKERID = "FlyFast";
	...
	protected Composite createPopulationModelCheckingComposite(Shell main,
		...
		return new FlyFastModelCheckerComposite(main, parent, spec);
	}
