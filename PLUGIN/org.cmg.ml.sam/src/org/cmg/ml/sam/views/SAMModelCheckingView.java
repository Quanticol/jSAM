...
public class SAMModelCheckingView extends ViewPart {

	/**
	 * The ID of the view as specified by the extension.
	 */
	public static final String ID = "org.cmg.ml.sam.views.SAMModelCheckingView";
...
//	private Action doubleClickAction;
	...
	private IConfigurationElement[] modelcheckers;
	 ...
	 * The constructor.
	 */
	public SAMModelCheckingView() {
		installHandler();
		this.languages = new HashSet<String>();
		IExtensionRegistry platformRegistry = Platform.getExtensionRegistry();
		this.modelcheckers = platformRegistry .getConfigurationElementsFor(JSAMMODELCHECKER_ID);
		for (IConfigurationElement e : this.modelcheckers) {
...
//		}
	...
	private LinkedList<IModelCheckerExtensionPoint> loadModelCheckers( String fileExtension ) {
		...
		for (IConfigurationElement e : modelcheckers) {
